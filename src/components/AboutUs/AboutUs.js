  ...
  return (<>
   <NavBar/>
    ...
    <div className={styles.contentHolder}>
      ...
      <p className={styles.textHolder}>Our pet sitters specialize in only one or two types of pets so that you can have the peace of mind knowing that your pet will receive the best care when you can't be there. Many of our pet sitters are also certified veterinary technicians, or have experience administering medications and can care for pets who are medically fragile.  

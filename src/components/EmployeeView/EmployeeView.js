...
export const EmployeeView = () => {
    ...
    useEffect(() => {
        fetch(
            `${API}/employees?userId=${employeeId}&_expand=user&_expand=petType`
        )
            .then((res) => res.json())
            .then((data) => {
                setEmployee(data[0])
    ...
    return (
        <>
            ...
            <div className="container">
                ...
                <div
                    className={`d-flex flex-column justify-content-left ${styles.empTable}`}
                >
                    ...
                    <p>
                        *{employee.user.fullName}{" "}
                        {employee.medications === 0 ? "cannot" : "can"} deliver
                        medications/care for sick pets
                    </p>
                </div>

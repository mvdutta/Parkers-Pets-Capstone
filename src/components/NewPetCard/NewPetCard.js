        ...
        <>
            <div key={key} className={`card ${styles.myCard}`}>
                ...
                <div className={`card-body ${styles.cardBody}`}>
                    ...
                    <p className={`card-text ${styles.cardText}`}>Age: {age}</p>
                    <button
                        className={style1.detailButton}
                        onClick={getPetDetails}
                    >
                        Details
                    </button>
                    <button className={style1.deleteButton} onClick={deletePet}>
                        Delete
                    </button>
                </div>
            </div>
